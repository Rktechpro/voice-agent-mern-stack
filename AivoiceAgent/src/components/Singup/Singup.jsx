...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-t from-[#0b0b0b] to-[#111212ea] bg-cover bg-center bg-no-repeat flex justify-center items-center px-4">
      <div className="w-full max-w-md bg-[#0000001a] backdrop-blur-md p-6 sm:p-8 rounded-lg shadow-lg border border-b-orange-500 border-t-violet-700 border-l-pink-700 border-r-green-600">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-[#44c9ac5f] text-white p-2 rounded-md hover:bg-[#fb00ff51] transition duration-200"
          >
            Sign Up
          </button>
        </form>
